...
public class HttpUtil {
	 ...
	 * @return
	 */
	public static JSONObject post(String url, String data, User user, String pid) {
	...
	private static void setHeader(HttpPost httpPost, User user) {
	...
	private static void setHeader(HttpPost httpPost, User user, String pid) {
		httpPost.setHeader("Cookie", user.getCookie());
		httpPost.setHeader(
				"User-Agent",
				"Mozilla/5.0 (iPhone; CPU iPhone OS 11_2_5 like Mac OS X) AppleWebKit/604.5.6 (KHTML, like Gecko) Mobile/15D60 MicroMessenger/6.6.3 NetType/4G Language/zh_CN");
		...
		if (StringUtils.isNotBlank(pid)) {
			httpPost.setHeader("Referer", "https://pet-chain.baidu.com/chain/detail?channel=market&petId=" + pid
					+ "&validCode=6848e4fc4175e6893c2e5d01e7d03a35");
		} else {
			httpPost.setHeader("Referer",
					"https://pet-chain.baidu.com/chain/detail?channel=market&petId=1855388969513255367&validCode=6848e4fc4175e6893c2e5d01e7d03a35");
		}
